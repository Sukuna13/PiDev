...
//controle de saisie:
    public Boolean ValidateDate() {
     ...
     public Boolean ValidateFields() {
        if (name.getText().isEmpty() | dated.getValue().toString().isEmpty() | datef.getValue().toString().isEmpty() | heured.getText().isEmpty() | heuref.getText().isEmpty() | locationevent.getText().isEmpty()) {
            Alert alert = new Alert(Alert.AlertType.WARNING);
            alert.setTitle("Validate fields");
            alert.setHeaderText(null);
    ...
    /*private void Boolean ValidateFields() {
