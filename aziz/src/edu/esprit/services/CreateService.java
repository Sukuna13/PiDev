...
public class CreateService {
    ...
    public void ajoutercaractérestiques (caractérestiques_sportif C){
        ...
        String requete ="INSERT INTO caracteristiques_sportif(id_caracteristique, id_sportif, taille_sportif, poid_sportif, age_sportif, sexe_sportif, objectif_nutrition, Bmi_sportif, Besoin_bmi, Besoin_protein, Besoin_carbs, Besoin_calories, Besoin_fat) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
                PreparedStatement pst =cnx.prepareStatement(requete);
