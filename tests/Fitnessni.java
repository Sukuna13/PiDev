...
public class Fitnessni {
    ...
    public static void main(String[] args) {
        ...
        /* // works
         ...
         e= new Event(10,"natation",dt,dt2,3,7,"ariana","photo1"); 
         ecd.ajouterEvent2(e);
        */
        ...
        /* //works
         ...
         Date dt2 =Date.valueOf(dte2);
         Event e2 = new Event("run for your life",dt,dt2,1,10,"tunis","ph");
         e2.setIdEvent(3);
       ...
       /* //works 
        c = new Commentaire(10,"salle de sport","commentaire1"); 
        ccd.ajouterCommentaire2(c);
        */
         /////////////////////////to test modifier commentaire methode /////////////////////////// 
        /*
         Commentaire c3 = new Commentaire(10,"coach","commentaire 2");
