...
public class TestServer {
     ...
     private static final String SECRET = "6LffDMQeAAAAAJnVmfu7NIHcXr2CsLCekHGJgVoA";
    private static final String SITE_KEY = "6LffDMQeAAAAAI_wzm4bnMDUIApwGcRBr8cm_MV-";
    ...
    public static void main(String[] args) throws Exception {
        ...
        server.start();
        System.out.println("Starting Server on http://localhost:80" );
    }
