...
public class GeneratingPDF {
    ...
    public void GeneratePdf(Employe R1) {

        try {
            //file generated's name
            String dir = System.getProperty("user.dir");//get project source path
            File name = new File(dir + "\\ressources\\PDFS\\" + R1.getNom_emp() + ".pdf");//add the full path /ressources + file name
            ...
            //load content
            Paragraph title = new Paragraph(R1.getNom_emp());
            Paragraph description = new Paragraph(R1.getPrenom_emp());
    ...
    public File GetGeneratePdf(Employe R1) {
   //file generated's name
            String dir = System.getProperty("user.dir");//get project source path
            File name = new File(dir + "\\ressources\\PDFS\\" + R1.getNom_emp()+ ".pdf");//add the full path /ressources + file name
